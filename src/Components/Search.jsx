...
const Search = () => {
  ...
  return (
    <div className="bg-white shadow-md rounded-full py-2 px-4 flex items-center gap-2 w-full sm:max-w-lg md:max-w-2xl lg:max-w-4xl mx-auto relative">
      {/* Location */}
...
<div className="flex flex-col w-1/4">
  ...
  <div className="flex items-center">
    ...
    <button
      onClick={() => alert("Select a check-in date")}
...
<div className="flex flex-col w-1/4">
  ...
  <div className="flex items-center">
    ...
    <button
      onClick={() => alert("Select a check-out date")}
      className="text-gray-400 ml-auto"
    >
      ▼
    </button>
      ...
      {/* Search Button */}
      <button className="bg-black text-white rounded-full p-3 flex items-center justify-center absolute right-1">
        <svg
